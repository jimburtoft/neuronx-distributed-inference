#!/bin/bash
# MiniMax M2.5 BF16 - 64K config
# max-model-len=65792, max-num-seqs=8, batch_size=8
# context_encoding=[65536], token_generation=[65792]
# Input: 59500, Output: 300
...
python3 -m vllm.entrypoints.openai.api_server \
    ...
    --additional-config '{
        "override_neuron_config": {
            ...
            "token_generation_buckets": [65792],
