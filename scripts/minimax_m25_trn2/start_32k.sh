#!/bin/bash
# MiniMax M2.5 BF16 - 32K config
# max-model-len=33024, max-num-seqs=16, batch_size=16
# context_encoding=[32768], token_generation=[33024]
# Input: 29700, Output: 300
...
python3 -m vllm.entrypoints.openai.api_server \
    ...
    --additional-config '{
        "override_neuron_config": {
            ...
            "ctx_batch_size": 1,
            "tkg_batch_size": 16,
            "max_context_length": 33024,
            "seq_len": 33024,
            "async_mode": true,
            "flash_decoding_enabled": false,
            "enable_bucketing": true,
            "context_encoding_buckets": [32768],
            "token_generation_buckets": [33024],
