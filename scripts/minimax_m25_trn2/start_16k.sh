#!/bin/bash
# MiniMax M2.5 BF16 - 16K config
# max-model-len=16640, max-num-seqs=32, batch_size=32
# context_encoding=[16384], token_generation=[16640]
# Input: 14800, Output: 300
...
python3 -m vllm.entrypoints.openai.api_server \
    ...
    --additional-config '{
        "override_neuron_config": {
            ...
            "ctx_batch_size": 1,
            "tkg_batch_size": 32,
            "max_context_length": 16640,
            "seq_len": 16640,
            "async_mode": true,
            "flash_decoding_enabled": false,
            "enable_bucketing": true,
            "context_encoding_buckets": [16384],
            "token_generation_buckets": [16640],
