...
class PixtralInferenceConfig(ImageToTextInferenceConfig):
    def __init__(
        ...
        **kwargs,
        ...
        # Fused speculation is supported for image-to-text/multimodal models
        # (Voxtral audio) as of this fork. The prior guard is removed; audio/
        # vision embeddings are scattered into inputs_embeds for both target and
        # draft during prefill (see NeuronFusedSpecModel._context_encoding_forward).
